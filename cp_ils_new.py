...
dataset_name = '/Users/sam/Library/CloudStorage/OneDrive-Personale/Bank Customer Churn XAI Project/2) Credit Card Churn/df3_clean.csv'
df = pd.read_csv('/Users/sam/Library/CloudStorage/OneDrive-Personale/Bank Customer Churn XAI Project/2) Credit Card Churn/df3_clean.csv', index_col=0)
...
with open('/Users/sam/Library/CloudStorage/OneDrive-Personale/Bank Customer Churn XAI Project/2) Credit Card Churn/lgb.pkl', 'rb') as file:
...
#cat_features_list = ['Gender', 'NumOfProducts', 'HasCrCard', 'IsActiveMember']
...
def generate_counterfactuals(df_instances, features_to_change, max_features_to_change, 
                             n_cfs=10, n_feats_sampled=2, topn_to_check=3):
